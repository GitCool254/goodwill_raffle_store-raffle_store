...
export default function Catalog({ openProduct }) {
  ...
  const catalogItems = [
    ...
    },
    {
      ...
      ticketPrice: 10,
      description: "Light Grey weave fabric with piping on edge.<br /> It can give a hint of beige with the wood trim. Bought at The Brick, special ordered as colour not shown in store.<br /> The legs and bottom is wood trim in a medium to dark stain. <br /> This sectional is very heavy and good quality.<br /> The extra seat can be attached to make one side longer or used as extra seat like here. <br />95”x 95” width and XSeat is 24”width, and all seating 34” in depth (Back to front),height is 34” floor to top of cushion.<br /> There is no marks nicks or stains. No pets, no kids, non smoking very clean home! It never gets sat on only when company comes for seasonal holidays! <br />I can show how to connect the extra seat.",

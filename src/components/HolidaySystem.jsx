          ...
          <div className="marquee-container">
            <div className="marquee-content">
              <div className="inline-flex items-center" style={{ fontSize: 0 }}>
                ...
                <h3 className="premium-title inline-block text-base" style={{ fontSize: '1rem', marginLeft: -2 }} data-text={`${holiday.name} starts in 2 days! Get ready for special offers.`}>

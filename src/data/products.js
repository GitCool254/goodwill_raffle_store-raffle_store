...
export const catalogItems = [
  ...
  // ----- Electronics -----
  {
    ...
    image: "/treadmill carbon.jpg",
    images: [
      "/treadmill carbon.jpg",
      "/treadmill1.png",
      "/treadmill2.png",
      "/treadmill3.png",
      "/treadmill5.png",
  ...
  // ----- Furniture -----
  {
    ...
    marketPrice: 400,
    description:
      "• Kitchen Island.Excellent condition no damages.\n• Dimensions 1.5m long, 1m wide and 1m high.",
    image: "/K Island.jpg",
    images: [
      "/K Island.jpg",
      "/K Island1.png",
  ...
  },
  {
    ...
    marketPrice: 450,
    description:
      "• Elevate your outdoor space with this exquisite Brand Broyhill patio set. Perfect for entertaining, this set comfortably seats 7 and includes a table plus two extra seats, expanding to accommodate up to 9 people. \n\n• It's used only once, it looks like new. \n• Free of parties, kids and pets.",
    image: "/Sofa set.jpg",
    images: [
      "/Sofa set.jpg",
      "/Sofa set1.jpg",
  ...
  },
  {
    id: "p16",
    category: "Household",
    title: "Fishing Tackle & Equipment",
    ticketPrice: 6,
    marketPrice: 300,
    description: `◆ Complete Rod & Reel Combos\n• Shimano Charter Special Lever Drag Reel Combo (ideal for trolling & bottom fishing)\n• Okuma Cerros Casting Rod & Low-Profile Baitcasting Setup\n• Piscifun Salis X Heavy-Duty Trolling Reel on Shimano Rod\n• 2x Conventional/Trolling Reel Combos (including blue-anodized reel setup), all pre-spooled with high-strength braid or mono.\n\n◆ ​Bulk Rod Collection:\n​• Large assortment of casting, spinning, and heavy conventional rods with cork and EVA foam grips.\n\n◆ High-End Offshore Saltwater Rods\n• Premium blanks including Graftech GOF78M (7'8", 30–40 lb class) and Calstar 700M / T670-H (40–100 lb class) with heavy-duty roller and frame guides.\n\n◆ 10-Piece Lure Set + Tackle Box\n• 5x Floating/Sinking Minnow Jerkbaits (3D eyes, realistic scale patterns, sharp treble hooks)\n• 5x Metal Blade / Vibration Vibe Baits (great for deep water action)\n• Includes clear plastic compartment organizer box (all lures individually sealed/brand new) \n\n◆ Bulk Leadhead Swimbait Hooks\n• Large lot of unpainted lead fish-head jigheads with 3D eye sockets and corrosion-resistant hooks—ready for soft plastic swimbaits or custom painting.\n\n◆ Condition\n• Tackle & Lures: Brand new in original packaging.\n• Rods & Reels: Pre-owned in solid, smooth working condition with normal cosmetic wear from light boat use.`,
    image: "/Fishing Rod2.png",
    images: [
      "/Fishing Rod2.png",
      "/Okuma fishing rod.jpg",
      "/Fishing Rod3.png",
      "/Fishing Rod1.png",
      "/Fishing Rod4.jpg",
      "/Fishing Rod.png",
